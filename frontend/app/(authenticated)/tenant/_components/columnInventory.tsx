...
import { BranchType, InventoryType } from "@/app/types/types";
...
export const columnInventory: ColumnDef<InventoryType>[] = [
  {
    accessorKey: "id",
    header: () => <div className="text-center w-full">Inventory ID</div>,
    cell: ({ getValue }) => (
  ...
  },
  {
    ...
    header: () => <div className="text-center w-full">Batch ID</div>,
    cell: ({ getValue }) => (
      <div className="text-center w-full">{getValue() as string}</div>
    ),
  },
...

  {
    ...
    header: () => <div className="text-center w-full">Storage Location</div>,
    cell: ({ getValue }) => (
      <div className="text-center w-full">{getValue() as string}</div>
    ),
  },
...

  {
    ...
    header: () => <div className="text-center w-full">Purchase Date</div>,
    cell: ({ row }) => {
...

  {
    ...
    header: () => <div className="text-center w-full">Expiry Date</div>,
    cell: ({ getValue }) => (
      <div className="text-center w-full">{getValue() as string}</div>
    ),
  },
